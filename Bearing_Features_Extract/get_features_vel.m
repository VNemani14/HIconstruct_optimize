...
% The code extracts the features from the raw Velocity vibration signal
...
for mybid=1:15
    load("../Raw_Data/VBearing_"+ num2str(mybid) +'.mat')
    rawnet = permute(vbearing,[3,2,1]);
    ...
    save("FeaturesVel_B_"+string(mybid)+".mat",'Fnet','FTh','FFh','FTv','FFv')

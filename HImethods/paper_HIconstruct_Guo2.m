...
% "A recurrent neural network based health indicator for remaining useful life prediction of bearings" by L. Guo et al.
% But use a more exhaustive feature set

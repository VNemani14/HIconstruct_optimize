...
parfor cv = 1:ncv
    nlhs = 1000; %number of LHS samples for optimization - we will double it inside the code
    testb =  TESTB(cv,:);
    ...
    for mylhs = 1:nlhs
        ...
        [obj1(mylhs), obj2(mylhs)]  = get_othermetrics(ALLHI(mylhs,trainb), FPT(trainb), 1, 0);
    end
